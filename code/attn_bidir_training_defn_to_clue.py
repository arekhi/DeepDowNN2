...
encoder_LSTM = keras.layers.LSTM(a_LSTM, return_state = True, return_sequences = True, name = 'encoder_LSTM')
encoder_LSTM_bwd = keras.layers.LSTM(a_LSTM, return_state = True, return_sequences = True, name = 'encoder_LSTM_bwd', go_backwards = True)
